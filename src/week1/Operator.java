...
public class Operator {
	// Creating variables
	public int t; //target value is t
	public int[] input; //integer array to hold any integers input
	public String output;
	public int count ;
	

	//constructor to initialize the values for target 'k' and array 'input'
	public Operator(int t,int[] input){ 
	...
	if(count==0) {
	output="There cannot be any combination of +,-,* with input array : " + Arrays.toString(input) + " to reach target : "+ t;
	}
